...
## Current Stage: Backend Evaluation Closure and SQL Governance
...
- [x] Govern the two failures from the 20-Case Text-to-SQL run: `conversation-v9` states that
      ...
      model sequence invalid. Local red/green tests are complete; clean-revision cloud re-tests for
      `sql-equipment` and `sql-customer-distribution` remain pending.
